...
for i, s in enumerate(scenes):
    ...
    if is_video:
        ...
        if dur > veo_dur:
            ...
            vf = f"scale=1280:720:force_original_aspect_ratio=increase,crop=1280:720,setsar=1,setpts={ratio}*PTS"
        else:
        ...
        cmd = ["ffmpeg", "-y", "-loop", "1", "-i", src,
               "-t", str(dur),
               "-vf", f"scale=1400:788:force_original_aspect_ratio=increase,crop=1400:788,"
